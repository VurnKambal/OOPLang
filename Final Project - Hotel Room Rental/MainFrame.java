...
public class MainFrame extends JFrame
{
    ...
    private void initRentalPanel()
    {
        ...
        gridConstraints.anchor = gridConstraints.LAST_LINE_END;
        gridConstraints.insets = new Insets(10,10,10,10);
        rentalPanel.add(orderButton, gridConstraints);
    ...
    public void resetSelections()
    {
        ...
        snacksCheckbox.setEnabled(false);
        beveragesCheckbox.setSelected(false);
        beveragesCheckbox.setEnabled(false);
        membershipCheckbox.setSelected(false);
        membershipCheckbox.setEnabled(false);
        bedsCheckbox.setSelected(false);
        bedsCheckbox.setEnabled(false);
    ...
    private void orderButtonActionPerformed(ActionEvent e)
    {
        JFrame f = new JFrame();
        this.dispose();
        JOptionPane.showMessageDialog(f, "" + roomLabel + " Room : $ " + roomPrice + " \n\n" +
                             "Extras\n" +
                             ...
                             "Total Bill  : $ " + totalBill, "Bill", JOptionPane.INFORMATION_MESSAGE);
        exitProgram(f);
    }
